...
var Chosen = (function () {
    ...
    Chosen.prototype.buildHtml = function (items, $element, options) {
        ...
        var $dropdownContainer = this.buildChosenContainer(options), $dropdownMask = options.isMultiple
            ? this.buildMultipleDropdownMask(options)
            : this.buildSingleDropdownMask(options), $dropdown = this.buildDropdown(options, items);
    ...
    Chosen.prototype.buildSingleDropdownMask = function (options) {
        var $dropdownMaskContainer = document.createElement('a'), $selectedValueContainer = document.createElement('span'), $caretContainer = document.createElement('div'), $caret = document.createElement('b');
    ...
    Chosen.prototype.buildDropdown = function (options, items) {
        var $dropdownContainer = document.createElement('div'), $searchInputContainer = document.createElement('div'), $searchInput = document.createElement('input'), $resultsContainer = document.createElement('ul'), $results = this.buildResults(items);
    ...
    Chosen.prototype.buildResults = function (items) {
        ...
        var resultsElements = this.resultsElements, options = this.options, query = this.query, selectedValue = this.selectedValue;
    ...
    Chosen.prototype.getItems = function ($select) {
        var $options = $select.querySelectorAll('option[value]:not([value=""])'), items = [];
    ...
    Chosen.prototype.setSelectedValue = function (value) {
        var previousSelectedValue = this.selectedValue;
        this.selectedValue = value;
        var selectedItem = this.getItemByValue(value), selectedItemText = selectedItem.text || '';
