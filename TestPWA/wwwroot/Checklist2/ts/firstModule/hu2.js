...
exports.htmlEncode = exports.htmlDecode = void 0;
...
function htmlDecode(s) {
    ...
    for (var i = 0; i < len; i++) {
        ...
        if (state == 1) {
            ...
            else if (is_hex_value && isHexDigit(c_1)) {
                number = number * 16 + parseInt(c_1, 16);
                have_trailing_digits = true;
                rawEntity.push(c_1);
            }
            else if (isDigit(c_1)) {
                number = number * 10 + (c_1.charCodeAt(0) - '0'.charCodeAt(0));
                have_trailing_digits = true;
                rawEntity.push(c_1);
            }
            else if (number == 0 && (c_1 == 'x' || c_1 == 'X')) {
                is_hex_value = true;
                rawEntity.push(c_1);
            }
            else {
...
function htmlEncode(s) {
    ...
    for (var i = 0; i < s.length; i++) {
        var c_2 = s[i];
        if (c_2 == '&' || c_2 == '"' || c_2 == '<' || c_2 == '>' || c_2.charCodeAt(0) > 159
            || c_2 == '\'') {
            needEncode = true;
            break;
        }
