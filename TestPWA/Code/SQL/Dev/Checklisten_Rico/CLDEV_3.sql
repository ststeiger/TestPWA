...
DECLARE @___ResourceName nvarchar(16),@BE_ID int,@CL nvarchar(36)

SET @___ResourceName=N'CL_THTD_List.sql'
SET @BE_ID=12435
SET @CL=N'22d9548e-9fb9-41a4-a2d9-823b96a5b4b7' -- Mitarbeiterliste
