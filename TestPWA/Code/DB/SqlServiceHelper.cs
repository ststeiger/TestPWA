...
namespace AnySqlWebAdmin
{
        ...
        :System.Collections.Generic.IDictionary<string, object>
    {
        ...
        ICollection<string> IDictionary<string, object>.Keys => throw new System.NotImplementedException();

        ICollection<object> IDictionary<string, object>.Values => throw new System.NotImplementedException();

        int ICollection<KeyValuePair<string, object>>.Count => throw new System.NotImplementedException();

        bool ICollection<KeyValuePair<string, object>>.IsReadOnly => throw new System.NotImplementedException();

        object IDictionary<string, object>.this[string key] { get => throw new System.NotImplementedException(); set => throw new System.NotImplementedException(); }
        ...
        {
            throw new System.NotImplementedException("Add");
        }
        ...
        {
            throw new System.NotImplementedException("Remove");
        }
        ...
        {
            throw new System.NotImplementedException("Clear");
        }

        bool ICollection<KeyValuePair<string, object>>.Contains(KeyValuePair<string, object> item)
        {
            throw new System.NotImplementedException("Contains");
        }
        ...
        {
            foreach (KeyValuePair<string, object> kvp in this.GetParameters)
            {
                yield return kvp;
            }

            foreach (KeyValuePair<string, object> kvp in this.PostParameters)
            {
                yield return kvp;
            }

            foreach (KeyValuePair<string, object> kvp in this.CustomParameters)
            {
                yield return kvp;
            }
            ...
            if (this.InputStream != null && this.InputStream.Count > 0)
            {
                foreach (KeyValuePair<string, object> kvp in this.InputStream[0])
                {
                    yield return kvp;
                }
            }
        ...
        {
            IEnumerable e1 = ((IEnumerable)this);
            return e1.GetEnumerator();
        }
    ...
    public class SqlServiceHelper
    {
        ...
        public static async System.Threading.Tasks.Task<RequestParameters> GetParameters(Microsoft.AspNetCore.Http.HttpContext context)
        {
            // Note: 
            ...
            if (lss != null)
            {
                parameters.InputStream = lss;
            }


            if (context.Request.HasFormContentType)
            {
                foreach (System.Collections.Generic.KeyValuePair<string, Microsoft.Extensions.Primitives.StringValues> kvp in context.Request.Form)
                {
                    if (ParameterNameHelper.IsInvalid(kvp.Key))
                        continue;

                    parameters.PostParameters[kvp.Key] = System.Convert.ToString(kvp.Value);
                } // Next kvp 
            ...
            {
                foreach (System.Collections.Generic.KeyValuePair<string, Microsoft.Extensions.Primitives.StringValues> kvp in context.Request.Query)
                {
                    if (ParameterNameHelper.IsInvalid(kvp.Key))
                        continue;

                    parameters.GetParameters[kvp.Key] = System.Convert.ToString(kvp.Value);
                } // Next kvp 
